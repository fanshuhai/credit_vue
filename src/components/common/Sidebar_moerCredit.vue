    ...
    const sideDate=[
        ...
        },
        {
            ...
            subs: [
                ...
                // 个人信息核查-个人投资核查 _ start   fsh 2018.11.27
                {
                    index: '3-3',
                    title: '个人投资核查',
                    subs: [
                        {
                            index: 'personalInvestment',
                            title: '个人投资核查',
                            subs:[],
                        },
                    ]
...
//                      }
                ...
                //   personalJudicial
                    ...
                    subs: [
                        {
                            index: 'personalJudicialVerification',
                            title: '个人司法信息核查'
                        },
                    ]
                },
...
>>>>>>> 4aaa06e46aa2269a4bb9f52ef6de200d5f2c11f7
        ...
        computed: {
            onRoutes(){
                if(this.$route.path.replace('/','') == 'enterpriseReport') {
