           ...
           <el-container class='main_mo'>
               <el-header>
                   <div class="header_contain">
                      ...
                      <div class="header_input enterReport">
                        <el-row :gutter="30" type="flex" justify="center">
                          <el-form :model='ruleForm' :rules='rules' :inline="true"  ref='ruleForm' style="width: 50%;">
                            <el-col :span="18">
                                <el-form-item label=""  prop="enterName" style="width: 100%;">
                                    <el-input placeholder="请输入企业名称/企业注册号" v-model="ruleForm.enterName" clearable>
               ...
               <el-main>
                   <div class="main_contain_title">企业信用数据服务</div>
        ...
        methods:{
          ...
          QueryResult(formName){  
            this.$refs[formName].validate((valid)=>{
              ...
              let regEntr=/.*[\u4e00-\u9fa5]+.*$/;
              let enterMsg={};
              let ruleName=$.trim(this.ruleForm.enterName);
              if(valid){
                this.loading=true;
...
//                console.log(res.data);
                  ...
                  if(res.data==='登录超时'){
                    ...
                    //保存企业查询报告
                    localStorage.setItem("enReMsg",msgData);
                    
                    this.totalMessage=res.data;
                    // 兄弟组件传信息
                    bus.$emit('enReMsg',this.totalMessage)

                    this.$router.push({path:'/enterpriseReport',query:{ruleName}});
